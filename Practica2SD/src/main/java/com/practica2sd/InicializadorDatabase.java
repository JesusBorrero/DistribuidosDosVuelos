...
public class InicializadorDatabase {
    ...
    public void init() {
        ...
        Compania compania1 = new Compania("Iberia", "IB", "https://www.iberia.com/es/", "901 11 15 00", 4);
        companiaRepositorio.save(compania1);
        try {
            Vuelo vuelo1 = new Vuelo("IB0001", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("12:00:00"), 2.5, 100);
            Vuelo vuelo2 = new Vuelo("IB0002", new Date(fecha.parse("31/05/2020").getTime()), Time.valueOf("15:00:00"), 2.5, 120);
